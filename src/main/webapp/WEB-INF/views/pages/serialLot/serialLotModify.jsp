...
>
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <!-- 수정 폼 -->
        <form id="modifyForm" role="form" action="/serialLot/serialLotModify" method="POST">
          <div class="row mb-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              value='<c:out value="${get.item_name}"/>'>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              value='<c:out value="${get.supplier}"/>' readonly="readonly">
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              value='<c:out value="${get.stock_quantity}"/>' >
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              value='<fmt:formatDate value="${get.expiration_date}" pattern="yyyy-MM-dd" />'>
            </div>
          </div>
  ...
  <script src="../resources/assets/js/pages/serialLotModify.js"></script>
</body>
</html>
