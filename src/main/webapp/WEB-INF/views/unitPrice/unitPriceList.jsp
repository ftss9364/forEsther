														...
														<div>
															<div class="input-group input-group-merge">
																...
																<!-- 		<input type="text" name="keyword" class="form-control"
																	placeholder="Search..." aria-label="검색..."
														...
														<tbody>
															...
															<c:forEach items="${list}" var="unitPrice">
																<tr>
																	...
																	<td><c:out
																			value="${unitPrice.serialLotVO.item_code}" /></td>
																	<td><c:out value="${unitPrice.item_name}" /></td>
																	<td><c:out value="${unitPrice.standard_cost}" /></td>
																	<td><c:out value="${unitPrice.purchase_price}" /></td>
																	<td><c:out value="${unitPrice.selling_price}" /></td>
																</tr>
							...
							<div class="modal-dialog modal-lg modal-dialog-centered"
								...
								<div class="modal-content">
									...
									<form id="registerForm" class="modal-body"
										action="/unitPrice/register" method="post">
										<div class="row g-2">
											<div class="col mb-0">
										...
										<div class="row g-2">
											<div class="form-floating col mb-0">
												<input type="text" class="form-control" id="sy-sl-autocomplete"
										...
										<div class="row g-2">
											<div class="form-floating col mb-0">
												<input type="text" class="form-control" id="floatingInput"
													placeholder="예시) 김치찌개" aria-describedby="floatingInputHelp" />
												<label for="floatingInput">품목명</label>
											</div>
											<div class="form-floating col mb-0">
												<input type="text" class="form-control" id="floatingInput"
													placeholder="예시) 10000"
										...
										<div id="sy-cal-body">
													...
													<div class="row g-2">
														<div class="col form-check mt-3">
															<input name="default-radio-1" class="form-check-input"
																type="radio" value="" id="defaultRadio1" /> <label
																class="form-check-label" for="defaultRadio1">
																표준원가대비 </label>
														</div>
														<div class="col form-check">
															<input name="default-radio-1" class="form-check-input"
																type="radio" value="" id="defaultRadio2" checked /> <label
																class="form-check-label" for="defaultRadio2">
																구매단가대비 </label>
														</div>
													</div>
												</div>
											...
											<div class="row g-2">
												...
												<div class="form-floating col mb-0">
													<input type="text" class="form-control" id="floatingInput"
														placeholder="예시) 10%" aria-describedby="floatingInputHelp" />
													<label for="floatingInput">마진율</label>
												</div>
											</div>
										</div>
									</form>
							...
							<div class="modal-dialog modal-lg modal-dialog-centered"
								...
								<div class="modal-content">
									...
									<div id="sy-modal-body" class="modal-body">
										...
										<br>
										<div class="row g-4">
											<div class="col mb-0">Serial/Lot No</div>
											<div id="sy-read-modal-sl" class="col mb-0"></div>
											<div class="col mb-0">표준원가</div>
											<div id="sy-read-modal-op" class="col mb-0"></div>
										</div>
										<br>
										<div class="row g-4">
											<div class="col mb-0">품목명</div>
											<div id="sy-read-modal-in" class="col mb-0"></div>
											<div class="col mb-0">구매단가</div>
											<div id="sy-read-modal-bp" class="col mb-0"></div>
										</div>
										<div class="row g-4">
											<div class="col mb-0"></div>
											<div class="col mb-0"></div>
											<div class="col mb-0">판매단가</div>
											<div id="sy-read-modal-sp" class="col mb-0"></div>
										</div>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-label-secondary"
